  ...
  return (
    <div className="app">
      ...
      <header className="header">
        <div className="logo"><img src="/logo.png" alt="FastDeliver Logo" style={{ height: '50px', marginRight: '10px' }} /> FastDeliver</div>
        <nav className="nav">
      ...
      <section id="home" className="hero">
        <div className="hero-content" data-aos="fade-up">
          <img src="/logo.png" alt="FastDeliver Logo" style={{ height: '120px', marginBottom: '2rem' }} />
